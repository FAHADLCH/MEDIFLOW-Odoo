...
class MediflowPortal(CustomerPortal):
    ...
    def portal_my_appointments(self, **kw):
        ...
        return request.render("mediflow_portal.portal_my_appointments", values)
    ...
    def portal_my_lab_results(self, **kw):
        ...
        return request.render("mediflow_portal.portal_my_lab_results", values)
    ...
    def portal_my_invoices(self, **kw):
        ...
        return request.render("mediflow_portal.portal_my_invoices", values)
    ...
    def portal_my_consents(self, **kw):
        ...
        return request.render("mediflow_portal.portal_my_consents", values)
