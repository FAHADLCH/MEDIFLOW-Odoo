...
class MediflowLabResult(models.Model):
    ...
    _sm_groups = {
        ("preliminary", "verified"): "mediflow.group_mediflow_lab_verifier",
        ("verified", "released"): "mediflow.group_mediflow_lab_verifier",
        ("released", "amended"): "mediflow.group_mediflow_lab_verifier",
    }
