# -*- coding: utf-8 -*-
{
  ...
  <div style="max-width:1080px;margin:0 auto;padding:0 14px;box-sizing:border-box;font-family:-apple-system,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#1A1A1A;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:14px;margin-top:18px;">
      <div style="box-sizing:border-box;background-color:#FFFFFF;border:1px solid #E6E6E6;border-radius:14px;padding:22px;text-align:center;">
    ...
    <div style="box-sizing:border-box;width:100%;margin:24px 0 8px;border-radius:18px;padding:clamp(28px,5vw,42px) clamp(20px,4vw,42px);background-color:#0B0B0B;text-align:center;">
      <div style="display:inline-block;background-color:#FFFFFF;border-radius:18px;padding:16px 22px;max-width:100%;box-sizing:border-box;">
        <img src="sa_systems_logo.png" alt="SA Systems" style="display:block;width:clamp(160px,45vw,340px);height:auto;"/>
      </div>
    ...
    "currency": "USD",
    "category": "Healthcare",
    # Series-agnostic: a bare "2.0.1" installs on Odoo 18 and 19 alike.
    "version": "2.0.1",
    "data": [
