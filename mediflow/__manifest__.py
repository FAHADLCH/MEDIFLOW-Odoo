# -*- coding: utf-8 -*-
{
  ...
  <div style="max-width:1080px;margin:0 auto;padding:0 14px;box-sizing:border-box;font-family:-apple-system,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#1A1A1A;">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:14px;margin-top:18px;">
      <div style="flex:1 1 160px;max-width:100%;box-sizing:border-box;background-color:#FFFFFF;border:1px solid #E6E6E6;border-radius:14px;padding:22px;text-align:center;">
    ...
    "currency": "USD",
    "category": "Healthcare",
    # Series-agnostic: a bare "2.0.7" installs on Odoo 18 and 19 alike.
    "version": "2.0.7",
    "data": [
